    ...
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <IonRow className="top-nav-row">
          ...
          <IonCol size="6" sizeMd="3">
            <IonButton expand="block" routerLink="/albums">
              Albums
            </IonButton>
          </IonCol>
          ...
          <IonContent className="ion-padding">
            <IonRow>
              <IonCol size="12" sizeMd="4">
                <img
                  src="/team.jfif"
                  alt="Ionic Soundwaves Team"
                  className="modal-team-cover"
                />
              </IonCol>
              <IonCol>
                <p>
                  Ionic Soundwaves was founded in 1993 with a passion for
                  underground music. Our mission is to promote soulful and
                  hip-hop artists from around the world, providing a platform
                  for emerging talents to share their stories through beats and
                  lyrics.
                </p>
                <p>
                  Over the years, we've grown from a small local label to a
                  recognized name in the industry, collaborating with artists
                  around the world. We believe in the power of music to connect
          ...
          <IonRow>
            ...
            <IonCol size="12" sizeMd="6">
              <IonCard className="news-card">
                ...
                <IonCardHeader>
                  <IonCardTitle>
                    <strong>Release:</strong> {albums[0]?.name}{" "}
                  </IonCardTitle>
                </IonCardHeader>
            ...
            <IonCol size="12" sizeMd="6">
              <IonCard className="news-card">
                ...
                <IonCardHeader>
                  <IonCardTitle>
                    <strong>Showcase:</strong> {albums[4]?.name}
                  </IonCardTitle>
                </IonCardHeader>
                <IonCardContent className="news-text">
                  {" "}
          ...
          <IonRow>
            ...
            <IonCol size="12" sizeMd="4">
              <IonCard className="news-card">
                ...
                <IonCardHeader>
                  <IonCardTitle>
                    <strong>Release:</strong> {albums[8]?.name}
                  </IonCardTitle>
                </IonCardHeader>
                <IonCardContent className="news-text">
                  {" "}
            ...
            <IonCol size="12" sizeMd="4">
              <IonCard className="news-card">
                ...
                <IonCardHeader>
                  <IonCardTitle>
                    <strong>Showcase:</strong> {albums[10]?.name}
                  </IonCardTitle>
                </IonCardHeader>
                <IonCardContent className="news-text">
                  {" "}
            ...
            <IonCol size="12" sizeMd="4">
              <IonCard className="news-card">
                ...
                <IonCardHeader>
                  <IonCardTitle>
                    <strong>Release:</strong> {albums[2]?.name}
                  </IonCardTitle>
                </IonCardHeader>
                <IonCardContent className="news-text">
                  {" "}
